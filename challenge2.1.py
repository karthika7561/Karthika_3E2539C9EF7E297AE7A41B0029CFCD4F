'''Implement a class called BanklAccount that represents a bank acount.The class should have private 
...
xcannot be accessed directly from outside the class.Write a program to create an instance of the
...
class BankAccount:
  ...
  def deposit(self, amount):
   if amount > 0:
     ...
     print("Deposited ₹{}. New balance: ₹{}".format(account,  
  ...
  def display_balance(self):
    print("Account balance fro {} (Accountr #{}): ₹{}".format(
         self.__account_holder_name,self.__account_number,
         self.__account_balance))


# createban instance of the BankAccount class
